...
function judgeIosPermissionContact() {
  var result = false;
  var CNContactStore = plus.ios.importClass("CNContactStore");
...
function checkSystemEnableLocation() {
  if (isIos) {
    ...
    var cllocationManger: any = plus.ios.importClass("CLLocationManager");
    ...
    var locationManager: any = plus.android.importClass(
