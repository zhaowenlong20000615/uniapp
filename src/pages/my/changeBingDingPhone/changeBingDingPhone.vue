    ...
    <page-body>
        <view class="page">
            ...
            <view class="flex flex-direction align-center benben-flex-layout changeBingDingPhone_flex_1">
                ...
                <text class='changeBingDingPhone_fd1_1'>{{ userInfo?.mobile }}</text>
                ...
                <view class='flex flex-wrap align-center justify-center changeBingDingPhone_fd1_3'>
                    <benben-send-verification-code key='1688627152855' ref="vCode1688627152855"
                        class=' changeBingDingPhone_fd1_3_c0' after-text='后重新获取' before-text='获取验证码' type='3'
...
function nextPageFunc() {
    ...
    uni.navigateTo({ url: `/pages/my/inputNewPhone/inputNewPhone?code=${code.value}` })
}
</script>
