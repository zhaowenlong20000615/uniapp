<template>
    <view class='flex flex-direction flex-wrap align-stretch dingdanxq_fd1_0_c0_c3' v-for="(item, index) in listData"
        :key="item.aid">
        <text class='dingdanxq_fd1_0_c0_c2_c0' v-if="index === 0">返工详情</text>
        <view class='flex flex-wrap align-center justify-between dingdanxq_fd1_0_c0_c0_c0'>
            <text class='dingdanxq_fd1_0_c0_c0_c0_c0'>返工时间</text>
            <text class='dingdanxq_fd1_0_c0_c2_c1_c1'>{{ item.create_time }}</text>
        </view>
        <view class='flex flex-wrap align-center justify-between dingdanxq_fd1_0_c0_c0_c0'>
            <text class='dingdanxq_fd1_0_c0_c0_c0_c0'>返工备注</text>
            <text class='dingdanxq_fd1_0_c0_c2_c1_c1'>{{ item.rework_remarks }}</text>
        </view>
        <view class='flex flex-direction flex-wrap align-stretch dingdanxq_fd1_0_c0_c2_c3'>
            <text class='dingdanxq_fd1_0_c0_c2_c3_c0'>返工现场</text>
            <view class='flex flex-wrap align-center'>
                <image class='dingdanxq_fd1_0_c0_c2_c3_c1_c0' v-for="item1 in item.on_site_nodes" mode="aspectFit"
                    :src='item1'></image>
            </view>
        </view>
    </view>
...
import { GetReworkrecords } from '@/api/home';
import type { IGetReworkrecordsReq, IGetReworkrecordsRes } from '@/api/home/type';
...
const { listData, pagingListLoadedAll, pagingListNoListData, listDataLength, isLoadInit, pagingListToggle } = usePagingList<IGetReworkrecordsRes[], IGetReworkrecordsReq>({ minixPagingListsApi: GetReworkrecords, pagingListPostData })

function pagingListPostData() {
    return {
        freesystempointlocation_id: props.aid,
        freecompletionrecord_id: '',
    }
}
