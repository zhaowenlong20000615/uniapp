<template>
    <page-body>
        <view class="page">
            <view
                class="flex flex-direction flex-wrap align-stretch justify-center benben-position-layout flex wangbeiz_flex_0"
                :style="{ height: (88 + StatusBarRpx) + 'rpx', paddingTop: StatusBarRpx + 'rpx', }">
                <view class='flex flex-wrap align-stretch justify-between wangbeiz_fd0_0'>
                    <view class='flex flex-wrap align-center wangbeiz_fd0_0_c0' @tap.stop="handleJumpDiy"
                        data-type="back" data-url="1">
                        <text class='fu-iconfont2  wangbeiz_fd0_0_c0_c0'>&#xe794;</text>
                    </view>
                    <view class='flex flex-wrap align-center'>
                        <text class='wangbeiz_fd0_0_c1_c0'>确认完工</text>
                    </view>
                    <view class='flex align-center justify-end wangbeiz_fd0_0_c2'>
                    </view>
                </view>
            ...
            <view class="flex flex-direction flex-wrap align-stretch benben-flex-layout">
                <view class='flex flex-direction align-stretch wangbeiz_fd1_0'>
                    <text class='wangbeiz_fd1_0_c0'>完工备注</text>
                    <view class='flex flex-direction flex-wrap align-stretch'>
                        <view class='flex flex-wrap wangbeiz_fd1_0_c1_c0'>
                            <benben-textarea class='flex wangbeiz_input_fd1_0_c1_c0' confirm-type="done"
                                :placeholder="'请输入您的备注'" :maxlength="300" placeholder-style="color:#999;font-size:28rpx"
                                v-model="foremans_remarks" />

                        </view>
                    </view>

                </view>
                <!-- <view class='flex flex-direction align-stretch ' style="padding: 24rpx;">
                    ...
                    <view class='flex flex-direction flex-wrap align-stretch' style="margin-top: 24rpx;">
                        <benben-images-upload ref="benbenImagesUploadfd1_0_c3_c0" v-model:img-list="imageList"
                            v-model:img-ids="completion_site" :maxlength="6">
                ...
                <button class='flex-sub wangbeiz_fd1_1' @tap.stop="postfeedbackFunc()" open-type="contact">确认</button>
            </view>
...
import { SetCompletionrecordGongtou } from '@/api/home';
...
onLoad((options: any) => {
    const { freeengineeringprojects_id, freesystempointlocation_id } = options
...
const foremans_remarks = ref('')
const completion_site = ref('')
...
function postfeedbackFunc() {
    ...
    useDebounceFn(async () => {
        const post = {
            aid: freesystempointlocation_idRef.value,
            foremans_remarks: foremans_remarks.value
        }
        const { code, msg } = await SetCompletionrecordGongtou(post)
        Message.info(msg)
