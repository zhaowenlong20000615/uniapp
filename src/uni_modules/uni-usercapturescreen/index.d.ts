...
interface SetUserCaptureScreenOtions {
  enable: boolean
  success?: UniNamespace.OnUserCaptureScreenCallback
  fail?: UniNamespace.OnUserCaptureScreenCallback
  complete?: () => void
}
...
declare interface Uni {
  ...
  setUserCaptureScreen(options: SetUserCaptureScreenOtions): void
}
