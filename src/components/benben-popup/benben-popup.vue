<template>
  <view v-if="visibleSync" :style="[
  ...
  ]" :class="{ 'fu-drawer-visible': showDrawer }" class="fu-drawer" @touchmove.stop.prevent="touchmoveStop"
    hover-stop-propagation>
    <fu-mask :custom-style="maskCustomStyle" :maskClickAble="maskCloseAble" :z-index="fuZindex - 2"
      :show="showDrawer && mask" @click="maskClick"></fu-mask>
    <view class="fu-drawer-content" @tap="modeCenterClose(mode)" :class="[
      ...
      <view class="fu-mode-center-box" v-if="mode == 'center'" :style="[centerStyle]">
        <scroll-view @tap.stop.prevent="touchmoveStop" @touchmove.stop.prevent="touchmoveStop" style="max-height: 80vh"
          class="fu-drawer-scroll-view" scroll-y>
          <slot />
        </scroll-view>
      </view>
      <scroll-view style="max-height: 100vh" @tap.stop.prevent="touchmoveStop" @touchmove.stop.prevent="touchmoveStop"
        class="fu-drawer-scroll-view" scroll-y v-else>
        <slot />
      </scroll-view>
    </view>
  </view>
