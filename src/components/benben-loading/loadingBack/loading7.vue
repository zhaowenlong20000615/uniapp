<template>
  <view class="box" :style="colorConfig">
...
.sword:nth-of-type(1) {
  left: 0%;
  top: 0%;
  border-bottom: 8rpx solid var(--color1, #007aff);
  animation: sword1 0.8s linear infinite;
}
.sword:nth-of-type(2) {
  right: 0%;
  top: 0%;
  border-right: 8rpx solid var(--color2, #29ffc6);
  animation: sword2 0.8s linear infinite;
}
.sword:nth-of-type(3) {
  right: 0%;
  bottom: 0%;
  border-top: 8rpx solid var(--color3, #12d8fa);
